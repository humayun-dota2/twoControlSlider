...
class RangeSlider: UIControl {
    ...
    var trackTintColor = UIColor.orange       //UIColor(white: 0.9, alpha: 1.0)
    var trackHighlightTintColor = UIColor(red: 71.0 / 255.0, green: 70.0 / 255.0, blue: 77.0 / 255.0, alpha: 1.0)          //UIColor(red: 0.0, green: 0.45, blue: 0.94, alpha: 1.0)
